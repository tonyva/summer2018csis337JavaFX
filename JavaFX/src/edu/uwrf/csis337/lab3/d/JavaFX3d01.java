package edu.uwrf.csis337.lab3.d;

/**
 * JavaFX3d01 - This is an example of a JavaFX program with 2D shapes,
 * 			 colors, opacity and Images
 *   
...
public class JavaFX3d01 extends Application {
	
	private final String TITLE = "JavaFX3d01: JavaFX Colors, Opacity and Images Example";
	...
	private static final String DIR = "file:src/edu/uwrf/csis337/lab3/d/";
	private static final String imageurl = DIR + "fiji.jpg";
    ...
    private StackPane addCenterPane() {
	   ...
	   Text text = new Text("CSIS\n337");
	   text.setFont(Font.font("Arial", FontWeight.BOLD, 100 ));
	   box.setClip( text );
	   ImageView fiji = new ImageView( new Image( imageurl ) );
	   wlist.add( fiji );
