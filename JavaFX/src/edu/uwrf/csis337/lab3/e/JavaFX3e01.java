...
/**
 * JavaFX3e01 - This is an example of a JavaFX program with 
...
public class JavaFX3e01 extends Application {
	
	private final String TITLE = "JavaFX3e01: JavaFX Nonresponsive Example - Loop holds up everything";
    ...
    public void animate(){
		...
		for (int i=0; i<ITERATIONS; i++){
	    	// Figure out where the oval is in the pane
