package edu.uwrf.csis337.lab7.b;

/**
 * JavaFX7b01 - This is an example of a basic JavaFX animation using SequentialTransition
 *   
...
public class JavaFX7b01 extends Application {
	
	private final String TITLE = "JavaFX7b01: JavaFX 3D Sequential & ParallelTransition Example";
	...
	private Pane addPane(){
		...
		TranslateTransition tt = new TranslateTransition( Duration.seconds( 10 ), sphere );
		tt.setByX( 200 );
		tt.setByY( 100 );
		tt.setByZ( 100 );
		...
		ScaleTransition st2 = new ScaleTransition( Duration.seconds( 10 ), sphere );
		st2.setToX( 1.0 );
		st2.setToY( 1.0 );
		st2.setToZ( 1.0 );

		TranslateTransition tt2 = new TranslateTransition( Duration.seconds( 10 ), sphere );
		tt2.setByX( -200 );
		tt2.setByY( -100 );
		tt2.setByZ( -100 );

		ParallelTransition paratt = new ParallelTransition( st2, tt2 ); 

		SequentialTransition seqt = new SequentialTransition( sphere, tt, pt, st, paratt );
		seqt.play();
